...
export const envokeCommentApi = createAction(
  '[Comment API] Envoke comment fetch API'
);

export const fetchApiCommentSuccess = createAction(
  '[Comment API] get all comment success',
  props<{ allcomments: any }>()
);
